...
<head>
    <meta charset="UTF-8">
    <title>Demande d'approbation d'Assistance</title>
</head>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6;">
    ...
    <p>
        ...
        a soumis une nouvelle demande d'assistance qui nécessite votre approbation finale.
    </p>
    ...
    <p>
        <strong>Type d'assistance :</strong> {{ $assistance->typeAssistance->nom }} <br>
        ...
        <strong>Statut actuel :</strong> {{ ucfirst($assistance->statut) }} <br>
