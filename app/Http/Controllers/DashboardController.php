...
// 8. ⁠solde disponible
                ...
                'membres_actifs' => Membre::where('status', 'actif')->count(),
                'membres_inactifs' => Membre::where('status', 'inactif')->count(),
                'credits_accordes' => Credit::count(),
                'dettes_en_attente' => Remboursement::where('status', 'en attente')->count(),
                'credits_en_cours' => Credit::where('status', 'en cours')->count(),
